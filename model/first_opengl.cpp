...
void first_opengl::load_OBJ(){
    ...
    if (model!=NULL)
    {
        ...
        model_texture=bindTexture(QPixmap("image/5.png"),GL_TEXTURE_2D);//把图片绑定到model_texture

        glBindTexture(GL_TEXTURE_2D,model_texture);//纹理绑定

        //GL_TEXTURE_CUBE_MAP -----xiaotian
        //glBindTexture(GL_TEXTURE_CUBE_MAP,model_texture);//纹理绑定
